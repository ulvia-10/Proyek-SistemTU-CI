    ...
    <div class="col-md-10 offset-1">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary"> <i class="fa fa-info-circle" aria-hidden="true"></i>  Detail Rincian Absen </h6>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        ?>
                        <div><label for="">Tanggal Rekapan : </label> <span><b><?php echo date('d F Y', strtotime($hasilDetail[0][0]['tanggal']) ); ?></b></span></div>
                        <?php
                        ...
                        ?>
                        <div><label for="">Kelas  : </label> <span><b><?php echo $kelas ?> - <?php echo $hasilDetail[0][0]['jurusan'] ?></b></span></div>
                    ...
                    <table class="table table-stripe" style="font-size: 13px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                ?>
                                <td>
                                    <label for="" class="badge badge-<?php echo $warna ?>">Kehadiran : <?php echo $keterangan ?></label>
                                </td>
                            </tr>
                            <?php $nomor++;} ?>
                ...
                <?php } else { ?>
                    ...
                    <div class="text-center">
                        <img src="<?php echo base_url('assets/images/undraw_accept_request_vdsd.png') ?>" alt="Illustrator" width="400">
                        <h4>Nihil !</h4>
                        <p>Siswa pada kelas <?php echo $kelas ?> - <?php echo $hasilDetail[0][0]['jurusan'] ?> hadir semua.</p>
                    </div>
