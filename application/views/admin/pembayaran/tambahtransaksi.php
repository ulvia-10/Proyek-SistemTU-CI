    ...
    <div class="row-mt-8">
        <div class="col-md-7">
            <div class="card">
                ...
                <strong style="margin-left: 150px;"> <i class="fa fa-user-plus" aria-hidden="true"></i> Form Tambah Data Pembayaran</strong>
                </div>
                ...
                <?php endif ?>
                <form action="<?php echo site_url('Pembayaran/tambahTransaksi')?>" method="post">
